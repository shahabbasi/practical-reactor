...
public class c5_CreatingSequence {
    ...
    public void interval() {
        Flux<Long> interval = Flux.range(0, 100).interval(Duration.ofMillis(1000)); //todo: change this line only
    ...
    public void repeat() {
        ...
        Flux<Object> repeated = Flux.generate(sink -> sink.next(counter.incrementAndGet())).take(1).repeat(9);
